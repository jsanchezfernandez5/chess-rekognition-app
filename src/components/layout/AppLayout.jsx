...
export default function AppLayout({ children }) {
  ...
  return (
    <div className="flex min-h-screen bg-[#F0F2F5]">
      ...
      <aside 
        className={`fixed top-0 left-0 bottom-0 w-72 bg-white border-r border-gray-200 z-50 flex flex-col transform transition-transform duration-300 ease-in-out ${
